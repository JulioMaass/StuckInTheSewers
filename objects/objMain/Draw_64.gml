...
if pressed_up then		{draw_sprite(sprButtonUp, 1,	64-16,		128+2+8)}
else					{draw_sprite(sprButtonUp, 0,	64-16,		128+2+8)}
if pressed_down then	{draw_sprite(sprButtonDown, 1,	64-16,		128+2-8+64)}
else					{draw_sprite(sprButtonDown, 0,	64-16,		128+2-8+64)}
if pressed_left then	{draw_sprite(sprButtonLeft, 1,	64-16-32,	128+2+32)}
else					{draw_sprite(sprButtonLeft, 0,	64-16-32,	128+2+32)}
if pressed_right then	{draw_sprite(sprButtonRight, 1,	64-16+32,	128+2+32)}
